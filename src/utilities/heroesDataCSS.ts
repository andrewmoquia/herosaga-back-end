...
export const spriteBg: any = {
   adventurer: {
      background: 'url(https://i.ibb.co/xHs4fL9/sprite-adventurer.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   civilian: {
      background: 'url(https://i.ibb.co/TggSsbh/sprite-civilian.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   ghost: {
      background: 'url(https://i.ibb.co/zGM6gtJ/sprite-ghost.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   warrior: {
      background: 'url(https://i.ibb.co/dJTPfsX/sprite-warrior.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   arabianfighter: {
      background: 'url(https://i.ibb.co/BVSkNHw/sprite-arabianfighter.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   devil: {
      background: 'url(https://i.ibb.co/r5bZHts/sprite-devil.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   pirate: {
      background: 'url(https://i.ibb.co/pKqPFCS/sprite-pirate.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   roshan: {
      background: 'url(https://i.ibb.co/6sKpmgw/sprite-roshan.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   herald: {
      background: 'url(https://i.ibb.co/Srr2Q80/sprite-herald.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   magician: {
      background: 'url(https://i.ibb.co/ZBm6kMb/sprite-magician.webp)',
      width: 'calc(128px/4)',
      height: 'calc(208px/4)',
      backgroundRepeat: 'no-repeat',
   },
   monk: {
      background: 'url(https://i.ibb.co/xXPJfYL/sprite-monk.webp)',
      width: 'calc(128px/4)',
      height: 'calc(208px/4)',
      backgroundRepeat: 'no-repeat',
   },
   vampire: {
      background: 'url(https://i.ibb.co/mTxp8xZ/sprite-vampire.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   darklord: {
      background: 'url(https://i.ibb.co/YjnLF7V/sprite-darklord.webp)',
      width: 'calc(128px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   scarletangel: {
      background: 'url(https://i.ibb.co/b3Zbpk7/sprite-scarletangel.webp)',
      width: 'calc(192px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   shiva: {
      background: 'url(https://i.ibb.co/6NxhqSG/sprite-shiva.webp)',
      width: 'calc(168px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
   titan: {
      background: 'url(https://i.ibb.co/0D9977t/sprite-titan.webp)',
      width: 'calc(160px/4)',
      height: 'calc(224px/4)',
      backgroundRepeat: 'no-repeat',
   },
   bahamut: {
      background: 'url(https://i.ibb.co/ssm6J0g/sprite-bahamut.webp)',
      width: 'calc(384px/4)',
      height: 'calc(384px/4)',
      backgroundRepeat: 'no-repeat',
   },
   leviathan: {
      background: 'url(https://i.ibb.co/wh0pqm3/sprite-leviathan.webp)',
      width: 'calc(384px/4)',
      height: 'calc(384px/4)',
      backgroundRepeat: 'no-repeat',
   },
   phoenix: {
      background: 'url(https://i.ibb.co/qds11t9/sprite-phoenix.webp)',
      width: 'calc(384px/4)',
      height: 'calc(384px/4)',
      backgroundRepeat: 'no-repeat',
   },
   siren: {
      background: 'url(https://i.ibb.co/c1frF2H/sprite-siren.webp)',
      width: 'calc(312px/4)',
      height: 'calc(192px/4)',
      backgroundRepeat: 'no-repeat',
   },
